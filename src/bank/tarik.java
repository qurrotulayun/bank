   ...
   public void ambil(int tab, int t){
       if(t%100!=0)
           ...
           if(t>tab)
               ...
               if(tab<=50000)
                   JOptionPane.showMessageDialog(null, "Saldo minimal harus Rp 50000, Segera lakukan penyeroran untuk menghindari penutupan akun.","CAUTION",2);
               }
       }   
   }
